...
def get_visitor_by_qr(qr_data):
    ...
    return frappe.db.get_value(
        "Visitor",
        visitor_id,
        ["name", "visitor_name", "visitor_company", "visitor_phone", "host_employee_name", "department", "visit_purpose", "status", "check_in_time", "check_out_time", "id_type", "id_number", "qr_code_image"],
        as_dict=True,
    )
