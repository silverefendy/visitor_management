...
app_include_css = "/assets/visitor_management/css/visitor_custom.css"
app_include_js = [
    "/assets/visitor_management/js/visitor_preview.js",
    "/assets/visitor_management/js/vms_navigation.js",
]
